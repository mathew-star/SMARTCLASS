...
function UserRegister() {
  ...
  return (
    ...
    <>
            ...
            <div className="hidden lg:flex items-center justify-center flex-1 bg-slate-600 text-black">
            ...
            <div className="w-full bg-slate-300 lg:w-1/2 flex items-center justify-center">
          ...
          value={formik.values.email} />
                {formik.touched.email && formik.errors.email ? <div className=' text-red-600'>{formik.errors.email}</div> : null}
                    ...
                    <input type={type} id="password" name="password" className="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300"           onChange={formik.handleChange}
          onBlur={formik.handleBlur}
          value={formik.values.password} />
            <span class="relative flex justify-end items-end " onClick={handleToggle}>
                ...
                {formik.touched.password && formik.errors.password ? <div className=' text-red-600'>{formik.errors.password}</div> : null}
                    ...
                    <input type={type} id="confirmPassword" name="confirmPassword" className="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300"  onChange={formik.handleChange}
          onBlur={formik.handleBlur}
