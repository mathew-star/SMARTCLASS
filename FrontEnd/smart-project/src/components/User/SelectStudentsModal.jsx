...
function SelectStudentsModal({ isOpen, onClose, onSave }) {
  ...
  const { currentClass, classMembers, userRoleInClass, fetchClassMembers } = useClassStore((state) => ({
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="sm:max-w-[425px] bg-[#151A2C] text-white p-8 rounded-lg shadow-lg w-96">
        <DialogHeader>
          ...
          <DialogDescription>
            Select students you want to assign.
          </DialogDescription>
        </DialogHeader>
        <div className="mt-2">
